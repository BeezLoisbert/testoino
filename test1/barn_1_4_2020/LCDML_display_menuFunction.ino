    ...
    ClickEncoder::Button b = encoder->getButton();
      ...
      switch (CASEluxBegin) 
      {
        ...
        case 2: //StarttimeM
          ...
          if((set_starttimeM) < 1) //Wertbegrenzung für Starttime [m] MIN
          {
          encValue=0;
          }    
          
          if((set_starttimeM) > 59) //Wertbegrenzung für Starttime [m] MAX
          {
          encValue=59;
          }
        ...
        case 4: //StartdurationM
          ...
          if((set_startdurationM) < 1) //Wertbegrenzung für Startduration [m] MIN
          {
          encValue=0;
          }    
          
          if((set_startdurationM) > 59) //Wertbegrenzung für Startduration [m] MAX
          {
          encValue=59;
          }
    ...
    ClickEncoder::Button b = encoder->getButton();
      ...
      switch (CASEluxEnd) 
      {
        ...
        case 4: //EnddurationM
          ...
          if((set_enddurationM) < 1) //Wertbegrenzung für Endduration [m] MIN
          {
          encValue=0;
          }    
          
          if((set_enddurationM) > 59) //Wertbegrenzung für Endduration [m] MAX
          {
          encValue=59;
          }
    ...
    ClickEncoder::Button b = encoder->getButton();
      ...
      switch (CASEhystON) 
      {
        ...
        case 2: //HystVerzögerungONM
          ...
          if((set_hysttimeONM) < 1) //Wertbegrenzung für HysttimeON [m] MIN
          {
          encValue=0;
          }    
          
          if((set_hysttimeONM) > 59) //Wertbegrenzung für HysttimeON [m] MAX
          {
          encValue=59;
          }
    ...
    ClickEncoder::Button b = encoder->getButton();
      ...
      switch (CASEhystOFF) 
      {
        ...
        case 2: //HystVerzögerungOFFM
          ...
          if((set_hysttimeOFFM) < 1) //Wertbegrenzung für HysttimeOFF [m] MIN
          {
          encValue=0;
          }    
          
          if((set_hysttimeOFFM) > 59) //Wertbegrenzung für HysttimeOFF [m] MAX
          {
          encValue=59;
          }
