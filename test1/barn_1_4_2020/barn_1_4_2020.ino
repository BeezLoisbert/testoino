...
LCDML_add         (8  , LCDML_0_4        , 3  , "Temperatur Offset"  , mFunc_tempOffset);        // this menu function can be found on "LCDML_display_menuFunction" tab
LCDML_add         (9  , LCDML_0_4        , 4  , "Energiesparmodus"   , mFunc_screensaverSetup);  // this menu function can be found on "LCDML_display_menuFunction" tab
LCDML_add         (10 , LCDML_0_4        , 5  , "Zurueck"            , mFunc_back);              // this menu function can be found on "LCDML_display_menuFunction" tab
LCDML_add         (11 , LCDML_0_4_2      , 1  , "Zeiten"             , NULL);                    // this menu function can be found on "LCDML_display_menuFunction" tab
LCDML_add         (12 , LCDML_0_4_2_1    , 1  , "Startzeit"          , mFunc_luxBegin);          // this menu function can be found on "LCDML_display_menuFunction" tab
LCDML_add         (13 , LCDML_0_4_2_1    , 2  , "Tages- + Endzeit"   , mFunc_luxEnd);            // this menu function can be found on "LCDML_display_menuFunction" tab
LCDML_add         (14 , LCDML_0_4_2_1    , 3  , "Zurueck"            , mFunc_back);              // this menu function can be found on "LCDML_display_menuFunction" tab
LCDML_add         (15 , LCDML_0_4_2      , 3  , "Hysteresen"         , NULL);                    // this menu function can be found on "LCDML_display_menuFunction" tab
LCDML_add         (16 , LCDML_0_4_2_3    , 1  , "Hysterese Ein"      , mFunc_HystON);            // this menu function can be found on "LCDML_display_menuFunction" tab
LCDML_add         (17 , LCDML_0_4_2_3    , 2  , "Hysterese Aus"      , mFunc_HystOFF);           // this menu function can be found on "LCDML_display_menuFunction" tab
LCDML_add         (18 , LCDML_0_4_2_3    , 3  , "Zurueck"            , mFunc_back);              // this menu function can be found on "LCDML_display_menuFunction" tab
LCDML_add         (19 , LCDML_0_4_2      , 2  , "Regler"             , mFunc_luxPID);            // this menu function can be found on "LCDML_display_menuFunction" tab
LCDML_add         (20 , LCDML_0_4_2      , 4  , "Zurueck"            , mFunc_back);              // this menu function can be found on "LCDML_display_menuFunction" tab
LCDML_add         (21 , LCDML_0          , 5  , "Info"               , mFunc_info);              // this menu function can be found on "LCDML_display_menuFunction" tab
LCDML_add         (22 , LCDML_0          , 6  , "Energiesparmodus"   , mFunc_screensaver);       // this menu function can be found on "LCDML_display_menuFunction" tab
